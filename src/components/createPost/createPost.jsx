    ...
    return (
        <form action={formAction}>
            <div className="flex my-4 items-center">
                <img src={session.user?.pfp} alt="pfp" width={45} height={45} className="mr-4 border rounded-tl-lg rounded-br-lg h-fit"></img>
                ...
                <Button variant="link" className="ml-4">Post</Button>
            </div>
